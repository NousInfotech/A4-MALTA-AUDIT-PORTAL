// File: steps/AICompletionAnswersStep.tsx
...
const AICompletionAnswersStep: React.FC<{
  engagement: any
  mode: "ai" | "hybrid"
  stepData: any
  ...
  const handleSave = async () => {
    try {
      ...
      const res = await authFetch(`${import.meta.env.VITE_APIURL}/api/completion-procedures/${engagementId}/save`, {
        method: "POST",
        body: form,
      });
  ...
  return (
    <div className="space-y-4">
      <div className="text-sm text-muted-foreground">
        Step-2: Generate answers for each completion section separately, then edit as needed. You can also upload files to store in the engagement library (Completion).
      </div>
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  disabled={generatingSections.has(section.sectionId) || !hasQuestions}
...
export default AICompletionAnswersStep