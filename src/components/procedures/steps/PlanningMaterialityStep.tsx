        ...
        <CardContent className="space-y-6">
          ...
          <Alert>
            ...
            <AlertDescription className="font-body">
              <strong>Planning Materiality:</strong> This threshold will be used throughout the planning phase to assess the significance of risks, account balances, and audit procedures. It helps determine the scope and nature of planning procedures.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
