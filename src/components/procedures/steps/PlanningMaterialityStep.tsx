      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-heading text-xl text-foreground flex items-center gap-2">
            ...
            Set Planning Materiality Threshold
          </CardTitle>
          <p className="text-muted-foreground font-body">
            Define the materiality threshold for planning procedures. This will be used to assess the significance of
        ...
        <CardContent className="space-y-6">
          ...
          <Alert>
            ...
            <AlertDescription className="font-body">
              <strong>Planning Materiality:</strong> This threshold will be used throughout the planning phase to assess
              the significance of risks, controls, and procedures. It helps determine the scope and nature of planning
              activities.
            </AlertDescription>
          </Alert>
        </CardContent>
