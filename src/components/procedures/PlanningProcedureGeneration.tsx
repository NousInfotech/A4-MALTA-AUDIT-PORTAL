...
import { PlanningSectionStep } from "./steps/PlanningSectionStep"
import { PlanningProcedureQuestionsStep } from "./steps/PlanningProcedureQuestionsStep"
...
export const PlanningProcedureGeneration: React.FC<PlanningProcedureGenerationProps> = ({
  ...
  const [selectedMode, setSelectedMode] = useState<GenerationMode | null>(existingProcedure?.mode || null)
  const [currentStep, setCurrentStep] = useState(existingProcedure ? 2 : 0)
  const [stepData, setStepData] = useState<StepData>(
    existingProcedure
      ? {
          materiality: existingProcedure.materiality,
          selectedSections: existingProcedure.selectedSections,
          questions: existingProcedure.questions,
          recommendations: existingProcedure.recommendations,
        }
      : {},
  )
  ...
  const modes = [
    ...
    },
    {
      ...
      title: "AI",
      description: "Let AI generate procedures based on client information",
      icon: Bot,
      color: "bg-accent",
      features: [
  ...
  const steps = [
    ...
    { title: "Select Sections", component: PlanningSectionStep },
    { title: "Review Procedures", component: PlanningProcedureQuestionsStep },
