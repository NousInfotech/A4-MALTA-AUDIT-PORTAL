...
//   // CRITICAL: Create a more robust loading state that combines all indicators
//   const isLoading = useMemo(() => {
//     return loading ||
//       pushing ||
//       pushingToCloud ||
//       isOperationInProgress ||
//       isPushingToCloudGlobal ||
//       isPushingRef.current ||
//       isPushingToCloudRef.current;
//   }, [loading, pushing, pushingToCloud, isOperationInProgress, isPushingToCloudGlobal]);

//   // CRITICAL: Create a more robust pushToCloud function
//   async function pushToCloud() {
//     console.log("Starting pushToCloud operation");

//     // Set all loading states and refs
//     setIsOperationInProgress(true);
//     setIsPushingToCloudGlobal(true); // CRITICAL: Set global flag
...
//     clearAllIntervalsAndRefs();

//     // CRITICAL: Store the start time for debugging
//     const startTime = Date.now();
//     console.log("API call started at:", new Date().toISOString());

//     try {
//       // CRITICAL: Create a more robust interval system
//       const ensureLoadingState = () => {
//         if (isPushingToCloudRef.current) {
//           setPushingToCloud(true);
//           setIsPushingToCloudGlobal(true);
//         }
...
//       // Start interval to protect pushing state from re-renders
//       pushingIntervalRef.current = setInterval(ensureLoadingState, 50);

//       // CRITICAL: Start interval to protect pushingToCloud state from re-renders
//       pushingToCloudIntervalRef.current = setInterval(ensureLoadingState, 50);

//       // Save ETB first
//       console.log("Saving ETB before push");
//       await saveETB(false);

//       // Ensure states are maintained after saveETB
//       ensureLoadingState();

//       // CRITICAL: Add a timeout to the API call to prevent hanging
//       const controller = new AbortController();
//       const timeoutId = setTimeout(() => {
//         console.log("API call timed out after 10 minutes");
//         controller.abort();
//       }, 600000); // 10 minutes timeout

//       console.log("Making API call to push to cloud");
...
//       // Update localStorage for button visibility
//       try {
...
//       // CRITICAL: Update state for button visibility BEFORE showing toast
//       setHasBeenPushed(true);
//       setForceUpdate((prev) => prev + 1);

//       // CRITICAL: Ensure loader state is still active before showing toast
//       ensureLoadingState();

//       // CRITICAL: Show toast AFTER all state updates are applied
//       console.log("Showing success toast");
//       toast({ title: "Pushed", description: "ETB uploaded to Excel Online." });

//       // CRITICAL: Keep loader visible for a moment after toast appears
//       await new Promise((resolve) => {
//         const toastStartTime = Date.now();
//         const checkInterval = setInterval(() => {
//           // Keep checking until 500ms have passed
//           if (Date.now() - toastStartTime >= 500) {
//             clearInterval(checkInterval);
//             resolve(null);
//           }
//           // Ensure loader stays visible during this time
//           ensureLoadingState();
//         }, 50);
//       });

//       console.log("Hiding loader after toast display");

//       // Now safely hide the loader
//       clearAllIntervalsAndRefs();
//       setPushingToCloud(false);
//       setPushing(false);
//       setIsPushingToCloudGlobal(false);

//       // Final state sync for button visibility
//       setForceUpdate((prev) => prev + 1);
//       try {
...
//       console.log("PushToCloud operation completed");
//     }
//   }
...
//           variant="pulse"
//           size="lg"
//           text={isPushingToCloudGlobal || isPushingToCloudRef.current ? "Pushing to Excel Online..." : "Loading Extended Trial Balance..."}
//         />
//       </div>
//     );
//   }
...
//                     variant="outline"
//                     onClick={pushToCloud}
//                     disabled={actualPushingToCloud || actualPushing}
//                     title="Overwrite Excel from current ETB"
//                     className="text-xs sm:text-sm bg-transparent"
//                   >
//                     {actualPushingToCloud || actualPushing ? (
...
//     try {
//       // Save ETB first, but skip calling loadExistingData
//       console.log("Saving ETB before push");
...
//       // Load existing data after operation is complete
//       // This is delayed to prevent interfering with the loading state
//       setTimeout(() => {
//         loadExistingData();
//       }, 100);
//     }
