export const NEW_CLASSIFICATION_OPTIONS = [
    ...
    "Assets > Current > Trade and other receivables > Trade Receivables",
    "Assets > Current > Trade and other receivables > Other receivables",
    "Assets > Current > Trade and other receivables > Amount due from Shareholder",
    "Assets > Current > Trade and other receivables > Amount due from Subsidiary Co.",
    "Assets > Current > Trade and other receivables > Amount due from Parent Co.",
    "Assets > Current > Trade and other receivables > Prepayments and accrued income",
    "Assets > Current > Held-for-trading investments",
    "Assets > Current > Loans > Amount advanced to subsidiary",
    "Assets > Current > Loans > Capital contribution",
    "Assets > Current > Cash and bank balances > Cash at bank",
    "Assets > Current > Cash and bank balances > Cash in hand",
    ...
    "Liabilities > Non-current > Borrowings > Loan from Subsidiary Co.",
    "Liabilities > Non-current > Borrowings > Loan from Parent Co.",
    "Liabilities > Non-current > Borrowings > Loan from Shareholder",
    ...
    "Liabilities > Current > Trade and other payables > Amount due to Subsidiary Co.",
    "Liabilities > Current > Trade and other payables > Amount due to Parent Co.",
    "Liabilities > Current > Trade and other payables > Amount due to Shareholder",
