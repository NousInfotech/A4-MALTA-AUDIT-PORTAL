...
export const ProceduresTab = ({ procedures, handleGenerateProcedures, isGeneratingProcedures }: ProceduresTabProps) => {
  return (
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>AI-generated procedures based on uploaded documents</CardDescription>
          </div>
