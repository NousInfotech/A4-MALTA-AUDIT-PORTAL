...
export const ComprehensiveNavigation: React.FC<ComprehensiveNavigationProps> = ({ className }) => {
  ...
  const navigationItems: NavigationItem[] = [
    ...
    },
    {
      ...
      subPages: [
        { title: "All Clients", href: "/employee/clients", icon: Building2, color: "text-gray-700", bgColor: "bg-gray-800", percentage: 75, description: "View all clients" },
        { title: "Add Client", href: "/employee/clients/new", icon: Plus, color: "text-gray-700", bgColor: "bg-gray-800", percentage: 0, description: "Add new client" },
        { title: "Client Reports", href: "/employee/clients/reports", icon: FileText, color: "text-gray-700", bgColor: "bg-gray-800", percentage: 60, description: "Client analytics" }
      ]
    },
    {
      title: "Engagements",
    ...
    },
    {
      ...
      badge: "New",
      subPages: [
        { title: "Questionnaire", href: "/employee/isqm", icon: Shield, color: "text-gray-800", bgColor: "bg-gray-900", percentage: 45, description: "Quality assessment" },
        { title: "Reports", href: "/employee/isqm/reports", icon: BarChart3, color: "text-gray-800", bgColor: "bg-gray-900", percentage: 30, description: "Quality reports" },
        { title: "Compliance", href: "/employee/isqm/compliance", icon: Target, color: "text-gray-800", bgColor: "bg-gray-900", percentage: 65, description: "Compliance status" }
      ]
    },
    {
      title: "KYC",
      ...
      badge: "New",
      subPages: [
        { title: "KYC Forms", href: "/employee/kyc", icon: UserCheck, color: "text-gray-700", bgColor: "bg-gray-800", percentage: 70, description: "Client verification" },
        { title: "Due Diligence", href: "/employee/kyc/due-diligence", icon: Eye, color: "text-gray-700", bgColor: "bg-gray-800", percentage: 55, description: "Due diligence checks" },
        { title: "Risk Assessment", href: "/employee/kyc/risk", icon: Shield, color: "text-gray-700", bgColor: "bg-gray-800", percentage: 40, description: "Risk evaluation" }
      ]
    },
    {
