...
import { SigningFlowComponent } from "./SigningFlow";
...
export function SigningPortalModal({
  selectedEngagement,
  open,
  onOpenChange,
  onEnterWorkspace,
  handleUploadSuccess,
}: SigningPortalModalProps) {
  return (
    // The Dialog's visibility is now controlled by the `open` and `onOpenChange` props
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="min-w-[75vw] h-[95vh] flex flex-col p-2">
