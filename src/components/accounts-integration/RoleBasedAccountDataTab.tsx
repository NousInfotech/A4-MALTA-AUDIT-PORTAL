          ...
          >
            <div className="space-y-8">
              ...
              {isClient ? (
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-100/50">
                  <div className="text-center space-y-4">
                    ...
                    <h4 className="text-xl font-bold text-slate-800">Read-Only Access</h4>
