...
//           {renderSpreadsheet()}
//           {renderSelectionFooter()} {/* Keep the selection footer here */}
//         </main>
//       </div>
//     );
//   }
...
// fullscreen Excel Viewer with it's header
...
//                         m.details.sheet === selectedSheet &&
//                         excelGridRowIndex >= m.details.start.row &&
//                         excelGridRowIndex <= (m.details.end?.row ?? m.details.start.row) &&
//                         excelGridColIndex - 1 >= m.details.start.col &&
//                         excelGridColIndex - 1 <= (m.details.end?.col ?? m.details.start.col)
//                     );
...
//                       >
//                         {cell}
//                         {mapping && !isHeaderCell && (
//                           <div className="absolute top-0 left-0 w-full h-full flex items-start justify-start p-1 pointer-events-none">
//                             <span
//                               className={`text-[15px] font-semibold text-red-500 px-1 rounded-sm ${mapping.color.replace('bg-', 'bg-')}`}
//                               style={{ transform: 'scale(0.8)', transformOrigin: 'top left' }} // Smaller text size
//                             >
...
//                               excelGridColIndex - 1 === m.details.start.col
//                           ) && (
//                             // This dot indicates the start of a mapping, can be kept or removed if the title is sufficient
//                             <div className="absolute top-0 right-0 w-2 h-2 bg-blue-500 rounded-full" />
//                           )}
//                       </TableCell>
//                     );
...
//         {/* Main content area */}
//         <main className="flex-1 p-4 bg-gray-50 flex flex-col w-full overflow-hidden">
//           <div className="flex-grow overflow-auto relative"> {/* Added relative to parent for absolute positioning of title */}
//             {renderSpreadsheet()}
//           </div>
//           {renderSelectionFooter()}
//         </main>
...
//           <ExcelViewer {...props} isFullscreenMode={true} onToggleFullscreen={() => setIsFullscreen(false)} />
//           <div className="absolute top-4 right-4 z-50"> {/* Increased z-index for the close button */}
//             <Button
//               variant="outline"
//               size="sm"
//               onClick={() => setIsFullscreen(false)}
