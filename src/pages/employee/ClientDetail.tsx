    ...
    <div className="min-h-screen bg-amber-50 p-6">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900 break-all">{client.email}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
                ...
                <div>
                  ...
                  <Badge variant="outline" className="bg-gray-100 text-gray-700 border-gray-200 rounded-xl px-4 py-1 text-sm font-semibold uppercase">
                    {client.role}
                  </Badge>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
                ...
                <div>
                  ...
                  <Badge variant="outline" className="bg-gray-100 text-gray-700 border-gray-200 rounded-xl px-4 py-1 text-sm font-semibold">
                    {client.industry || 'N/A'}
                  </Badge>
                </div>
              </div>
              ...
              <div className="p-4 bg-gray-50 rounded-xl">
                <p className="text-sm text-gray-500 font-medium mb-2">Company Summary</p>
      ...
      <div className="space-y-6 mt-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-gray-900">Engagements</h2>
            <p className="text-gray-600">Active and completed audit engagements</p>
          </div>
        </div>
                ...
                <div key={engagement._id} className="bg-white/60 backdrop-blur-md border border-white/30 rounded-2xl shadow-lg shadow-gray-300/30 hover:bg-white/70 transition-all duration-300 overflow-hidden">
                  <div className="p-6">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between w-full gap-4">
                      ...
                      <Badge variant="outline" className={`rounded-xl px-4 py-2 text-sm font-semibold ${
