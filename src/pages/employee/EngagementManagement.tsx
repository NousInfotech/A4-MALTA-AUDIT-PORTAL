...
import { Briefcase, Plus, Search, Calendar, Building2, FileText, Eye, Filter, TrendingUp, Clock } from 'lucide-react';
...
export const EngagementManagement = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20 p-6 space-y-8">
            ...
            <Card key={engagement._id} className="group bg-white/80 backdrop-blur-sm border border-blue-100/50 hover:border-blue-300/50 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden">
              ...
              <CardContent className="relative space-y-4">
                ...
                <div className="flex gap-3">
                  <Button
                    className="flex-1 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl py-3 h-auto group-hover:scale-105"
                    variant="default"
                    size="sm"
                    asChild
                  >
                  ...
                  <Button
                    className="flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl py-3 h-auto group-hover:scale-105"
                    variant="default"
                    size="sm"
                    onClick={() => handleStartEngagement(engagement)}
                  >
                    <Eye className="h-4 w-4 mr-2" />
                    Start Engagement
                  </Button>
      ...
      {/* E-Signature Portal Modal */}
      <SigningPortalModal
        selectedEngagement={selectedEngagement}
        open={isSigningPortalOpen}
        onOpenChange={setIsSigningPortalOpen}
